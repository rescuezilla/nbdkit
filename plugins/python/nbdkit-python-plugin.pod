...
Returns C<True> if the client completed TLS authentication, or false
...
a Python C<bytes> object.  See L<nbdkit-plugin(3)/Reading passwords>
for more information on the different ways that the C<value> parameter
can be parsed.
