...
change this curve.  All settings are in seconds.  For example, setting
C<half-seek-time=0.5 max-seek-time=1.0> will make seek times twice as
...
seconds.  The defaults are C<min-seek-time=0.01>,
C<half-seek-time=0.2> and C<max-seek-time=0.5>.
